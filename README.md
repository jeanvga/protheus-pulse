...
> **Estado do projeto:** MVP 0.1.2 concluído e pronto para piloto controlado. Cadastro, descoberta, coletores, alertas, heartbeats, retenção e instalação Windows estão funcionais.
