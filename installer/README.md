...
O ZIP self-contained é sempre produzido. Quando `ISCC.exe` está instalado, o script também produz `protheus-pulse-0.1.0-win-x64-setup.exe`. Cada pacote recebe um arquivo `.sha256`.
